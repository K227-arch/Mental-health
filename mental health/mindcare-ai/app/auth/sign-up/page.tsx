    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-surface px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-2xl p-8 shadow-sm">
          <h1 className="text-xl font-bold text-on-surface mb-6">Create Account</h1>
          ...
          <div className="flex flex-col gap-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-2.5 border border-outline-variant rounded-xl text-sm font-medium text-on-surface hover:bg-surface-container transition-colors"
            >
